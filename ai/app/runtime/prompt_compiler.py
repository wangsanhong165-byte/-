...
class PromptCompiler:
    ...
    def _output_protocol(language: str, emotions: str, behaviors: str) -> str:
        return (
            ...
            "{\"segments\":[{\"text\":\"...\",\"emotion\":\"neutral\",\"behavior\":\"speak\",\"attention\":\"user\",\"energy\":0.5,\"intensity\":0.5,\"naturalVAD\":{\"valence\":0,\"arousal\":0,\"dominance\":0},\"contextTags\":[],\"motionPlan\":{\"durationMs\":1200,\"steps\":[{\"atMs\":0,\"durationMs\":600,\"primitive\":\"nod\",\"intensity\":0.5}]}}],\"tool_calls\":[],\"final_reply\":\"...\"}\n"
            ...
            "   - Content that is a real explanation, tutorial, or technical walkthrough adds \"formal\" to contextTags and lowers energy to 0.3-0.4; heavy, somber, or reflective moments add \"somber\" with energy 0.2-0.3 and do NOT raise intensity — quiet weight, not dramatics.\n"
            ...
            "9. Leave tool_calls empty when not needed.\n"
            ...
            "11. Examples (format and emotion-splitting only — never copy their content):\n"
